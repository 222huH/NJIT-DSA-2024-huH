...
public class KeyValueArray<K extends Comparable<K>, V> implements Dictionary<K, V> {
    ...
    private Pair<K, V>[] pairs = null; // Array named pairs, with elements of type Pair
    private int count = 0;
    ...
    @Override
    // Return fill rate (i.e., ratio of stored elements to total array size)
    ...
    public void compress() throws OutOfMemoryError {
        ...
        // Then reallocate using the index from partitioning, pointing to the first null in the array.
